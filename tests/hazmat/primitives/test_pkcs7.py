...
class TestPKCS7SignatureBuilder:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                hashes.SHA256,
                ec.SECP256R1,
                "",
            ),
        ],
    )
    def test_sign_byteslike_deterministic_ecdsa(
        ...
        builder = (
            pkcs7.PKCS7SignatureBuilder()
            .set_data(data)
            .add_signer(cert, key, hashalg(), ecdsa_deterministic_signing=True)
        )

        sig = builder.sign(
            serialization.Encoding.SMIME,
            options,
            time=datetime.datetime(2024, 4, 23, 17, 3),
        )
        assert bytes(data) in sig
        test_support.pkcs7_verify(
            serialization.Encoding.SMIME,
